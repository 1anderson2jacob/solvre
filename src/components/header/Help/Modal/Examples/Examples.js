  ...
  return (
    <div className="Examples">
      ...
      <ul>
        ...
        <li><div data-state="present">R</div> & <div data-state="present">Y</div> show the letters are <em>correct</em>, are in the <em>incorrect</em> position, and have been clicked 1 time</li>
      </ul>
    </div>
  )
}
